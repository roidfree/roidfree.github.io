// -- this is MJS VERSION of the posts.js file that is used!
// could delete this file if not needed anymore
...
export const handler = async (event, context) => {
  ...
  try {
    console.log('Fetching posts from Notion database and from mjs:', databaseId);
